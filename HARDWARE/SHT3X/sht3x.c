...
#define ALERT_READ   0//(GPIOB->IDR  & 0x0400)     // read Alert
//=============================================================================


#define SHT3X_IIC_Init()         IO_IIC_Init()
#define SHT3X_IIC_Start()        IO_IIC_Start()
#define SHT3X_IIC_Stop()         IO_IIC_Stop()
#define SHT3X_IIC_Write_Byte(x)  IO_IIC_Write_Byte(x)
#define SHT3X_IIC_Read_Byte(x)   IO_IIC_Read_Byte(x)
#define SHT3X_IIC_Wait_Ack()     IO_IIC_Wait_Ack()

//-- Global variables ---------------------------------------------------------
static u8t _i2cAddress; // I2C Address

//-- Static function prototypes -----------------------------------------------
static etError I2c_WriteByte(u8t txByte);
...
{
  etError error;
  SHT3X_IIC_Write_Byte(txByte);
  error = (etError)SHT3X_IIC_Wait_Ack();
  return error;
}
static void I2c_StopCondition(void)
{
